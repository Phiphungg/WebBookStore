<footer class="text-center text-white mt-4"
	...
	<!--Call to action-->
	<div class="pt-4 pb-2">
		<a class="btn btn-outline-white footer-cta mx-2" href=""
			target="_blank" role="button">Download MDB <i
			class="fas fa-download ms-2"></i>
		</a> <a class="btn btn-outline-white footer-cta mx-2" href=""
			target="_blank" role="button">Start free tutorial <i
	...
	<div class="text-center p-3"
		...
		© 2024 Copyright: <a class="text-white"
			href="https://mdbootstrap.com/">MDB.com</a>
	</div>
	<!-- Copyright -->
</footer>